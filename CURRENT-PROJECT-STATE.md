...
- Authenticated navigation prioritizes daily counter work in this order: Dashboard, Billing, Orders / Collection, Customers, Current Stock, Add Stock and Sales. Catalogue, Measurements, Stitching Rates and Tailors remain available in a secondary Setup group, followed by Logout. The desktop sidebar compacts the complete navigation and Logout into the available height without an internal scrollbar. Customer records and balances/payments remain separate pages reached through clear tabs within the Customers area; active states and the collapsible mobile menu are preserved.
